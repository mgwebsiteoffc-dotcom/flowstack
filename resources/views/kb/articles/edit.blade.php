    ...
    <x-card title="Article details" icon="📚">
        <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2"><label class="block text-sm font-medium text-gray-700 mb-1">Content *</label>
                <textarea name="content" rows="14" required class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm font-mono">{{ old('content', $article->content) }}</textarea></div>
