...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="text-center max-w-md">
        ...
        <a href="{{ auth()->check() ? route('dashboard') : route('home') }}" class="inline-block mt-6 bg-indigo-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium">← Back to {{ auth()->check() ? 'dashboard' : 'home' }}</a>
    </div>
</body>
</html>
