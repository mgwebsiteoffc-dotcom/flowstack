...
<div class="flex items-center justify-between mb-5 flex-wrap gap-3">
    ...
    <a href="{{ route('time.all', array_merge(request()->query(), ['export' => 1])) }}" class="px-3 py-2 rounded-lg bg-white border border-gray-200 text-gray-600 text-sm"><x-icon name="arrow-down-tray" class="w-4 h-4 inline-block" /> Export</a>
</div>
...
<div class="grid lg:grid-cols-4 gap-6">
    ...
    <div class="lg:col-span-3">
        <x-card title="Entries" icon="clock" :padding="false">
