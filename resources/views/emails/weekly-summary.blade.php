    ...
    <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 28px;">
            ...
            <table style="width: 100%; font-size: 14px;">
                <tr><td style="padding: 8px 0; color: #4b5563;">✅ Tasks completed</td><td style="text-align: right; font-weight: 700; color: #111827;">{{ $stats['tasks_completed'] }}</td></tr>
                <tr><td style="padding: 8px 0; color: #4b5563;">⏱️ Hours logged</td><td style="text-align: right; font-weight: 700; color: #111827;">{{ $stats['hours_logged'] }}h</td></tr>
                <tr><td style="padding: 8px 0; color: #4b5563;">🎯 New leads</td><td style="text-align: right; font-weight: 700; color: #111827;">{{ $stats['new_leads'] }}</td></tr>
                <tr><td style="padding: 8px 0; color: #4b5563;">💰 Revenue collected</td><td style="text-align: right; font-weight: 700; color: #059669;">₹{{ number_format($stats['revenue']) }}</td></tr>
            </table>
