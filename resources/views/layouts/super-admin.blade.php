...
<body class="bg-gray-900 min-h-screen">
    <div class="flex min-h-screen">
        <aside class="w-56 bg-gray-950 text-gray-300 p-4 shrink-0">
            <div class="text-white font-black text-lg mb-6">Agency<span class="text-indigo-400">OS</span> <span class="text-xs bg-indigo-500 text-white px-2 py-0.5 rounded">super</span></div>
