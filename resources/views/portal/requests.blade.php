        ...
        <div class="flex items-center gap-3 px-5 py-4">
            <div class="flex-1 min-w-0">
                ...
                @if ($request->response_message)
                    <div class="text-xs text-green-700 mt-1 bg-green-50 rounded-lg p-2"><x-icon name="chat-bubble-left-right" class="w-4 h-4 inline-block" /> {{ $request->response_message }}</div>
                @endif
            </div>
