...
<div class="flex items-start justify-between gap-4 mb-5 flex-wrap">
    ...
    <div class="flex gap-2">
        <a href="{{ route('reports.pdf', $report) }}" class="px-3 py-1.5 text-sm rounded-lg bg-gray-100 text-gray-700">⬇ PDF</a>
...
<div class="grid lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-6">
        @forelse (($report->data['sections'] ?? []) as $key => $section)
            <x-card :title="['paid_advertising' => '📈 Paid Advertising', 'shopify' => '🛍️ Shopify', 'social_media' => '📱 Social Media', 'website' => '🌐 Website'][$key] ?? $key" :padding="false">
