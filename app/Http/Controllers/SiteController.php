    ...
    public function featuresData(): array
    {
        return [
            ...
            'project-tasks' => [
                ...
                'faq' => [
                    ['Can I automate recurring work?', 'Yes - mark a task as recurring (daily/weekly/monthly/custom) and Agency OS creates the next instance automatically on schedule.'],
            ...
            'leads-crm' => [
                ...
                'faq' => [
                    ['How does Lead365 sync work?', 'Lead365 posts webhook events (created, updated, stage changed, won, lost, form submitted, meta lead…) to your workspace. Agency OS logs every payload, processes it in the background and updates your pipeline automatically.'],
    ...
    public function useCasesData(): array
    {
        return [
            'digital-agency' => [
                ...
                'intro' => 'Marketing agencies juggle ad accounts, reporting decks, client calls and retainers. Agency OS gives you one place to run campaigns, track deliverables and report results - so nothing falls through the cracks.',
            ...
            'creative-agency' => [
                ...
                'intro' => 'Design agencies live on email threads full of revisions and "final_v3_FINAL" files. Agency OS moves briefs, feedback and approvals into one place your clients actually use.',
            ...
            'web-dev' => [
                ...
                'intro' => 'Development agencies need structure: sprints, tickets, client approvals and maintenance retainers. Agency OS gives your devs a clean task workflow and your clients a way to raise requests without Slack pings.',
            ...
            'consulting' => [
                ...
                'intro' => 'Consultants sell outcomes, not hours. Agency OS handles the proposal-to-delivery-to-invoice lifecycle so you can focus on the engagement.',
            ...
            'saas-agency' => [
                ...
                'intro' => 'Product agencies run on roadmaps, QA loops and release notes. Agency OS keeps the delivery side organized while clients stay in the loop through the portal.',
            ...
            'freelancers' => [
                ...
                'intro' => 'You are a one-person agency. Agency OS gives you the same tools the big agencies use - pipeline, proposals, invoicing, client portal - so you can charge like one.',
