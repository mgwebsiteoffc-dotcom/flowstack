 ...
 */
 ...
 $notifications->notifyRole($tenant, ['admin', 'ops_manager'], 'banknotes Invoice paid', $invoice->client->company_name.' — '.$invoice->invoice_number, 'finance.invoices.show', ['invoice' => $invoice->id]);
 $notifications->emailRole($tenant, ['admin', 'ops_manager'], 'banknotes Invoice paid: '.$invoice->invoice_number, $invoice->client->company_name.' paid '.$invoice->total_amount.' '.$invoice->currency.'.', 'invoice_paid');
 }
 }
