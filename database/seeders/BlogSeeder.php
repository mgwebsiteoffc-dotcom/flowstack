    ...
    public function run(): void
    {
        ...
        $posts = [
            ...
            [
                ...
                'content' => '<h2>What a portal changes</h2><p>Clients get a login where they can approve deliverables, view reports, download invoices and submit requests. No more email ping-pong.</p><h2>Launch it in a day</h2><p>In Task365, enable portal access on any client, and an invitation email is sent automatically with a set-password link. Clients only ever see their own company data.</p>',
            ],
        ];
